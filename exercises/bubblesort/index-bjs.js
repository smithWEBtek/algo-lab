...
var numbers2 = [3, 5, 2, 7, 5, 6, 9, 4, 23, 6, 42]

var startDiv = document.getElementById('start')
var button = document.getElementById('sortButton')
var resultDiv = document.getElementById('result')

startDiv.textContent = numbers1;
// startDiv.textContent = numbers2;
// startDiv.innerHTML = arr;


// ------------------------ 1 --------------------------------------
// function sortArr() {
// 	resultDiv.textContent = arr.sort((a, b) => a < b ? -1 : a > b ? 1 : null);
// 	// resultDiv.innerHTML = arr.sort((a, b) => a < b ? -1 : a > b ? 1 : null);
// }
